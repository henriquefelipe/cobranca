...
namespace Cobranca.Operadora
{
    internal class GerenciaNet
    {
        ...
        internal GerenciaNet(Credenciais credenciais)
        {
        ...
        #region PIX
        public GenericResult<CobResponse> PixCob(string token, Pagamento pagamento, string txtId)
        {
        ...
        public GenericResult<QrCodeResponse> PixLoc(string token, CobResponse cob)
        {
        ...
        public GenericResult<CobResponse> PixCobStatus(string token, string txtId)
        {
            var result = new GenericResult<CobResponse>();
            try
            {
        ...
        public GenericResult<DevResponse> PixDevolucao(string token, string txtId, string txtE2EId, decimal valor)
        {
